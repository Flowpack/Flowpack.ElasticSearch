...
class IndexCommandController extends \TYPO3\Flow\Cli\CommandController {
	...
	public function statusCommand($conductUpdate = FALSE, $clientName = NULL) {
		...
		/** @var $annotation \TYPO3\ElasticSearch\Annotations\Indexable */
	 ...
	 * @return array
	 */
	protected function getModificationsNeededStatesAndIdentifiers(\TYPO3\ElasticSearch\Domain\Model\Client $client, $className) {
