<?php
namespace TYPO3\ElasticSearch\Indexer\Aspect;
...
class IndexerAspect {
	...
	/**
	 * @Flow\AfterReturning("setting(TYPO3.ElasticSearch.realtimeIndexing.enabled) && within(TYPO3\Flow\Persistence\PersistenceManagerInterface) && method(public .+->(add|update)())")
	...
	/**
	 * @Flow\AfterReturning("setting(TYPO3.ElasticSearch.realtimeIndexing.enabled) && within(TYPO3\Flow\Persistence\PersistenceManagerInterface) && method(public .+->(remove)())")
	 * @param \TYPO3\Flow\Aop\JoinPointInterface $joinPoint
	 * @return string
	 */
